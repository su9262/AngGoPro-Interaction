...
class CrcCalc:
    ...
    def checkPck(self, packet):
        ...
        return cmp, bit1,bit2,bit3,bit4
...
def main():
    ...
    ser = serial.Serial(
        ...
        timeout=0.2) # 0 (non-block) / 0.1(100ms)
    ...
    #     stopbits=serial.STOPBITS_ONE,
    #     bytesize=serial.EIGHTBITS,
    #     timeout=0.01)  # 0 (non-block) / 0.1(100ms)
    #
    #
    # if angSer.isOpen():
    ...
    #     setAuto3D
    # crc = CrcCalc()
    # _, bit1,bit2,bit3,bit4 = crc.checkPck(setAuto3D)
        ...
        if rxdata == b'\xfa':
            ...
            if result == 1:
                ...
                if loc :
                    ...
                    #
                    #         size = frame.shape
                    #         inf.put([4 - math.ceil((x + w // 2) / size[1] * 3),
                    #                  2, distanceHuman])  # x,y,z
                    #
                    #     except:
                    #         pass
